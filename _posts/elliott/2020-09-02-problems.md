...
We're also going to start using some remote tools in preparation for **remote class next week*.
...
Check out the [before picture](/before-picture.html). You'll look back fondly on this first assignment from great heights of Pythonic fluency.

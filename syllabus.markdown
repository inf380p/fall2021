...
**I have family and friends who are at high risk of complications from COVID-19, as I'm sure many of you do, and take the health and safety of everyone in our classroom extremely seriously.** I will enforce all University, state, and locally mandated health policies, including social distancing and mandatory face coverings, so that we all stay as safe as possible. If any student is inadvertently putting others at risk, such as forgetting to wear a face covering, I will immediately remind them to follow these policies (and will have extra University-provided face coverings on hand if needed). If any student is deliberately putting others at risk through their behavior I will immediately end class and refer the student for disciplinary action. Materials for sanitization of hands and individual workspaces will be available before and after class. Please contact me or School administration with any concerns or questions.
